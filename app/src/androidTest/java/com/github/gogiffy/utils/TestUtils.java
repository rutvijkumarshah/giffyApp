package com.github.gogiffy.utils;
...
/**
 *
 * RecyclerView is diff than AdapterView so out of box espresso matcher wont work.
 *
 * Using this class from Andrdoi community to test Recyclerview code
 *
 * @Credit to dannyroa/espresso-samples (github)
 *
 */
...
public class TestUtils {
     ...
     */
    public static void waitForGiphyData(){
        SystemClock.sleep(TestData.WAIT_TIME_GIFY_DATA);
    }
}
